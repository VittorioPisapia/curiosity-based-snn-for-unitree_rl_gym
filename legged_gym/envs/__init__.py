...
from legged_gym.envs.go2.go2_config_cpg import GO2CPGCfg, GO2CPGCfgPPO
from legged_gym.envs.go2.go2_cpg_env import GO2CPGEnv
...
task_registry.register( "go2_cpg", GO2CPGEnv, GO2CPGCfg(), GO2CPGCfgPPO())
