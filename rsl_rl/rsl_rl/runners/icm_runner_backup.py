...
class IcmRunner ( SnnRunner ):
    def __init__(self,
        ...
        if self.use_icm:
            ...
            self.icm_optimizer = torch.optim.Adam(self.icm.parameters(), lr=5e-4)
        ...
        for it in range(self.current_learning_iteration, tot_iter):
            ...
            with torch.no_grad():
                for i in range(self.num_steps_per_env):
                    ...
                    if self.use_icm:
                        total_reward += (self.icm_intrinsic_coeff * intrinsic_reward).detach()
                    if self.use_rnd:
                        total_reward += (self.rnd_intrinsic_coeff * rnd_reward).detach()
            ...
            if self.use_icm:
                ...
                for epoch in range(self.icm_epochs):
                    ...
                    for i in range(0, dataset_size, batch_size):
                        ...
                        encoded_next_obs = self.icm.compute_encoded(mb_next_obs).detach()
